...
Створити похідні класи ВІДПОЧИНОК ВСЕРЕДИНІ КРАЇНИ (задаються вартість за 1 добу, вартість проїзду)
та АВТОБУСНИЙ ТУР ВСЕРЕДИНІ КРАЇНИ І ЗА КОРДОН (задаються тривалість всередині країни, 
вартість за 1 добу в гривнях, тривалість за кордоном, вартість за 1 добу у валюті). 
Для заданих прикладів путівок обчислити вартість кожної з них, впорядкувати путівки за спаданням вартості, 
враховуючи курс валюти, і обчислити сумарну вартість. 
